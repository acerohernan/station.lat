...
import { Box, Card, Typography, styled, Button, Divider, TextField } from '@mui/material';
    ...
    >
      <Box padding="24px" display="flex" flexDirection="column" alignItems={'center'}>
        ...
        <Box width={'100%'} marginTop={'30px'} marginBottom={'20px'} gap={'8px'} display={'grid'}>
          <Button href={apiUrl('/user/auth/google/authorize')} variant="outlined" size="large" fullWidth>
            Sign in with Google
          </Button>
        </Box>
